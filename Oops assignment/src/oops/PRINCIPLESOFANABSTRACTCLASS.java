...
public class PRINCIPLESOFANABSTRACTCLASS {
/*	1.IF ANY CLASS HAS METHOD AS ABSTRACT THEN THAT CLASS MUST BE DECLARED ABSTRACT 
	   YES , IF WE DOESNT MAKE THE CLASS AS ABSTRACT IT WILL GIVE ERROR .
	...
	2.ABSTRACT CLASS CANNOT BE INSTANTIATED
	  YES, BECAUSE IN ABSTARCT CLASS WE MIGHT HAVE ONLY ABSTRACT METHOD,WHEN WE HAVE
	  ABSTRACT METHOD THERE IS NO POINT OF INSTANTIATING THE CLASS AS THERE IS NOTHING TO 
	  ACCESS

	if we try to instantiate the abstract class it will give error
	...
	YES, BECAUSE WE CANNOT ACCESS THEM IN ANY SUBCLASS AND CANT PROVIDE IMPLEAMENTATION TO THAT 
	ABSTRACT CLASS

	5.ABSTRACT CLASS CANNOT BE FINAL
	YES, BECAUSE WE CAN ACCESS THEM IN ANY SUBCLASS BUT CAN'T PROVIDE IMPLEAMNETATION TO THAT 
	ABSTRACT CLASS OR CAN'T BE OVERRIDDEN.

	6.WE CAN DECLARE THE CLASS AS ABSTRACT WITHOUT HAVING ABSTRACT METHOD
	YES,BUT IF WE DO THAT WE CAN'T INSTATNTIATE THAT CLASS.*/
